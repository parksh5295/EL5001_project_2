...
def eval_policy(
    ...
    trace_algorithm: str = "stream_a2c",
    trace_split: str = "val",
...
def main():
    ...
    if args.trace_output_dir is not None and args.trace_max_eval_episodes > 0:
        trace_val_path = args.trace_output_dir / "stream_a2c_val_steps.jsonl.gz"
        trace_test_path = args.trace_output_dir / "stream_a2c_test_steps.jsonl.gz"
    val = eval_policy(
        model,
        val_env,
        args.eval_episodes,
