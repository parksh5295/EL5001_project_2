            ...
            rows.append(
                {
                    ...
                    "action_wait_unsure_ratio": metric.get("action_wait_unsure_ratio"),
                    "action_hold_active_ratio": metric.get("action_hold_active_ratio"),
    ...
    with args.output_csv.open("w", encoding="utf-8", newline="") as f:
        writer = csv.DictWriter(
            ...
            fieldnames=[
                ...
                "segment_boundary_f1",
                "action_wait_ratio",
                "action_wait_unsure_ratio",
                "action_hold_active_ratio",
                "action_start_ratio",
                "action_end_ratio",
